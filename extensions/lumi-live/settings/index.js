...
const elements = {
  ...
  mcpConnectorModalIcon: document.querySelector("#mcpConnectorModalIcon"),
  mcpConnectorModalTitle: document.querySelector("#mcpConnectorModalTitle"),
  mcpConnectorModalDescription: document.querySelector("#mcpConnectorModalDescription"),
  mcpConnectorModalFields: document.querySelector("#mcpConnectorModalFields"),
  mcpConnectorModalNote: document.querySelector("#mcpConnectorModalNote"),
