...
function showBlocked(error) {
  ...
  detail.textContent = error?.name === "SecurityError"
    ? "Chrome or your computer security policy blocked microphone capture. Open the settings below and allow Microphone for Lumi Live Side Panel."
...
async function requestMicrophone() {
  ...
  try {
    ...
    detail.textContent = "Return to the Lumi Side Panel and press Start voice. You can close this tab.";
